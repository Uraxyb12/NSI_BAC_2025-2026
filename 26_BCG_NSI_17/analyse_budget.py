...
def test_solde_annuel():
    assert solde_annuel(mouvements_test) == 150,False
print(test_solde_annuel())

#############################################################################
# Programme principal pour analyser le fichier complet                      #
#############################################################################
print(solde_annuel(lire_mouvements_depuis_csv('budget_complet.csv')))
